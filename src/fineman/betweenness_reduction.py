...
def betweenness_reduction(graph: dict[int, dict[int, int]], neg_edges,t_graph,t_neg_edges, tau, beta, c, seed = None):
    ...
    distances = {}
    for x in T:
        distances[x] = (b_hop_sssp(x, graph, neg_edges, beta), b_hop_stsp(x, t_graph,t_neg_edges, beta))
